    ...
    <form onSubmit={handleSubmit(onSubmit)} className="project-form">
      ...
      <div className="form-grid">
        <div className="form-group">
          ...
          <input {...register('githubUrl')} type="url" placeholder="https://github.com/username/repo" />
        </div>
        <div className="form-group">
          <label>Live URL</label>
          <input {...register('liveUrl')} type="url" placeholder="https://example.com" />
        </div>
      </div>

      <div className="form-group">
        <label>Image URL</label>
        <input {...register('imageUrl')} type="url" placeholder="https://example.com/image.jpg" />
      </div>
